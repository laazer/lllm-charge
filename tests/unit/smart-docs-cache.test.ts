...
import { TEST_CONFIG, createMockConfig } from '../setup'
import * as fs from 'fs/promises'
import * as path from 'path'

describe('SmartDocsCache', () => {
  let smartCache: SmartDocsCache
  let mockDocsIntelligence: jest.Mocked<DocsIntelligence>
  ...
  describe('Query Pattern Detection', () => {
    ...
    it('should respect confidence thresholds', async () => {
      ...
      const highThresholdCache = new SmartDocsCache(
        mockDocsIntelligence,
        mockKnowledgeBase,
        testProjectDir,
        {
  ...
  describe('Project Pattern Detection', () => {
    ...
    it('should detect Go project from go.mod', async () => {
      await fs.writeFile(
        path.join(testProjectDir, 'go.mod'),
  ...
  describe('Expiration and Cleanup', () => {
    ...
    it('should use custom expiration periods', async () => {
      const customCache = new SmartDocsCache(
        mockDocsIntelligence,
        mockKnowledgeBase,
        testProjectDir,
        {
  ...
  describe('Configuration Options', () => {
    it('should respect auto-download setting', async () => {
      const noAutoDownloadCache = new SmartDocsCache(
        mockDocsIntelligence,
        mockKnowledgeBase,
        testProjectDir,
        {
    ...
    it('should handle synchronous download when background is disabled', async () => {
      const syncCache = new SmartDocsCache(
        mockDocsIntelligence,
        mockKnowledgeBase,
        testProjectDir,
        {
