...
describe('Spec Cleanup API Client Methods', () => {
    ...
    test('scanSpecComments sends POST to /api/skills/spec-cleanup/scan', async () => {
        ...
        expect(global.fetch).toHaveBeenCalledWith(expect.stringContaining('/skills/spec-cleanup/scan'), expect.objectContaining({
            method: 'POST',
    ...
    test('runSpecCleanup sends POST to /api/skills/spec-cleanup/run', async () => {
        ...
        expect(global.fetch).toHaveBeenCalledWith(expect.stringContaining('/skills/spec-cleanup/run'), expect.objectContaining({
            method: 'POST',
