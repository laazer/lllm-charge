...
describe('Dashboard Component', () => {
    ...
    beforeEach(() => {
        ...
        apiClient.getAgents.mockResolvedValue(mockAgents);
        apiClient.getSpecs.mockResolvedValue(mockSpecs);
    });
    afterEach(() => {
    ...
    it('should render dashboard with loading state initially', () => {
        // Mock loading state
        ;
        apiClient.getProjects.mockImplementation(() => new Promise(() => { }));
        apiClient.getAgents.mockImplementation(() => new Promise(() => { }));
        apiClient.getSpecs.mockImplementation(() => new Promise(() => { }));
        render(<TestWrapper>
        <Dashboard />
      </TestWrapper>);
    ...
    it('should handle API errors gracefully', async () => {
        // Mock API failures
        ;
        apiClient.getProjects.mockRejectedValue(new Error('API Error'));
        apiClient.getAgents.mockRejectedValue(new Error('API Error'));
        apiClient.getSpecs.mockRejectedValue(new Error('API Error'));
        render(<TestWrapper>
        <Dashboard />
      </TestWrapper>);
