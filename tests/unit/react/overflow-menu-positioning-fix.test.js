...
describe('OverflowMenu Positioning Fixes', () => {
    ...
    test('Bottom-left position uses correct classes to avoid header overlap', () => {
        ...
        render(<OverflowMenu items={mockItems} buttonLabel="" buttonVariant="secondary" position="bottom-left"/>);
        // Open the menu
    ...
    test('Menu items are visible and clickable without overlap', () => {
        ...
        render(<OverflowMenu items={mockItems} buttonLabel="More" position="bottom-right"/>);
        // Open menu
        fireEvent.click(screen.getByText('More'));
