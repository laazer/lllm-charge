...
describe('Workflows - Gear Icon Editor Integration', () => {
    ...
    describe('Workflow Editor Opening', () => {
        it('should open workflow editor when gear icon is clicked', async () => {
            ...
            // Assert
            expect(mockWindowOpen).toHaveBeenCalledWith('http://localhost:3001/workflow-editor.html?workflowId=workflow-test-123', '_blank', 'width=1400,height=900');
        });
        it('should open workflow editor with correct workflow ID for each workflow', async () => {
            ...
            expect(mockWindowOpen).toHaveBeenCalledWith('http://localhost:3001/workflow-editor.html?workflowId=workflow-edit-456', '_blank', 'width=1400,height=900');
        });
        it('should open new window with proper dimensions', async () => {
            ...
            expect(mockWindowOpen).toHaveBeenCalledWith(expect.any(String), '_blank', 'width=1400,height=900');
        });
    });
    describe('Multiple Editor Windows', () => {
        it('should allow opening multiple workflow editors simultaneously', async () => {
            ...
            expect(mockWindowOpen).toHaveBeenNthCalledWith(1, 'http://localhost:3001/workflow-editor.html?workflowId=workflow-test-123', '_blank', 'width=1400,height=900');
            expect(mockWindowOpen).toHaveBeenNthCalledWith(2, 'http://localhost:3001/workflow-editor.html?workflowId=workflow-edit-456', '_blank', 'width=1400,height=900');
        });
    ...
    describe('URL Generation', () => {
        ...
        it('should handle special characters in workflow IDs', async () => {
            ...
            expect(mockWindowOpen).toHaveBeenCalledWith('http://localhost:3001/workflow-editor.html?workflowId=workflow-test_with-special.chars-123', '_blank', 'width=1400,height=900');
        });
    });
});
