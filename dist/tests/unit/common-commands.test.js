...
describe('CommonCommandHandler', () => {
    ...
    describe('Available Commands', () => {
        ...
        it('should categorize commands correctly', () => {
            const commands = handler.getAvailableCommands();
            const gitCommands = commands.filter(cmd => cmd.description.toLowerCase().includes('git') ||
                cmd.examples.some(ex => ex.includes('git')));
            const fileCommands = commands.filter(cmd => cmd.description.toLowerCase().includes('file') ||
