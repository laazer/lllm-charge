...
import { TEST_CONFIG, MockLLMProvider } from '../setup';
...
describe('HybridReasoning', () => {
    ...
    beforeEach(async () => {
        ...
        jest.spyOn(hybridReasoning, 'getLLMProvider')
    ...
    describe('Performance Optimization', () => {
        ...
        it('should handle concurrent reasoning requests', async () => {
            ...
            const promises = queries.map(query => hybridReasoning.processRequest({
                query,
                context: 'programming',
                useLocal: true,
                maxSteps: 2
    ...
    describe('Error Handling', () => {
        ...
        it('should provide fallback responses when knowledge is limited', async () => {
            ...
            expect(result.response.includes('unknown') ||
                result.response.includes('unable') ||
                result.response.includes('suggest')).toBe(true);
        });
