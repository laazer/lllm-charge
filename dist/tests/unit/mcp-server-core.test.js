...
describe('LLMChargeServer Core', () => {
    ...
    describe('Server Initialization', () => {
        it('should initialize all components successfully', () => {
            ...
            expect(server.knowledgeBase).toBeDefined();
            expect(server.reasoning).toBeDefined();
            expect(server.commandHandler).toBeDefined();
            expect(server.costTracker).toBeDefined();
        });
        it('should load configuration correctly', () => {
            expect(server.config).toEqual(mockConfig);
        });
        it('should set up tool handlers', () => {
            const handlers = server.toolHandlers || {};
    ...
    describe('Query Processing', () => {
        it('should process queries with local knowledge prioritization', async () => {
            ...
            await server.knowledgeBase.store('react-info', 'React is a JavaScript library', { type: 'documentation' });
        ...
        it('should provide cost analysis insights', async () => {
            ...
            await server.costTracker.recordRequest({
                isLocal: true,
                cost: 0,
                tokens: 100,
                model: 'llama2',
    ...
    describe('Error Handling', () => {
        ...
        it('should handle internal errors without crashing', async () => {
            ...
            jest.spyOn(server.reasoning, 'processRequest')
        ...
        it('should recover from component failures', async () => {
            ...
            jest.spyOn(server.knowledgeBase, 'searchSemantic')
    ...
    describe('Performance Optimization', () => {
        ...
        it('should handle concurrent requests efficiently', async () => {
            const requests = Array.from({ length: 5 }, (_, i) => server.callTool('llm_charge_query', {
                query: `Test query ${i}`,
                useLocal: true,
                maxSteps: 2
            }));
        ...
        it('should optimize resource usage under load', async () => {
            const heavyRequests = Array.from({ length: 10 }, (_, i) => server.callTool('llm_charge_command', {
    ...
    describe('Cost Optimization Features', () => {
        it('should automatically route to local models when appropriate', async () => {
            ...
            const metrics = await server.costTracker.getMetrics();
