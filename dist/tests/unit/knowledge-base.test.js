...
describe('KnowledgeBase', () => {
    ...
    describe('Embedding Operations', () => {
        it('should generate and cache embeddings', async () => {
            ...
            const embedding1 = await knowledgeBase.getOrCreateEmbedding(text);
            const embedding2 = await knowledgeBase.getOrCreateEmbedding(text);
        ...
        it('should handle embedding generation errors', async () => {
            ...
            await expect(knowledgeBase.getOrCreateEmbedding('test')).rejects.toThrow('Embedding error');
        });
    });
    ...
    describe('Error Handling', () => {
        it('should handle database errors gracefully', async () => {
            // Mock database error
            jest.spyOn(knowledgeBase.db, 'run').mockImplementationOnce((sql, params, callback) => {
