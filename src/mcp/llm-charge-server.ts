...
export class LLMChargeServer {
  ...
  private async handleBuildContextPackage(args: any) {
  ...
  private async handleSearchCodeSymbols(args: any) {
  ...
  private async handleGetContextTree(args: any) {
  ...
  private async handleGetFileSkeleton(args: any) {
  ...
  private async handleGetBlastRadius(args: any) {
  ...
  private async handleSemanticNavigate(args: any) {
  ...
  private async handleHybridReasoning(args: any) {
  ...
  private async handleStartRLMSession(args: any) {
  ...
  private async handleGetReasoningSession(args: any) {
  ...
  private async handleUpdateMemory(args: any) {
    await this.intelligence.updateMemory(
      args.nodeId,
      args.content,
      { type: args.type, ...args.metadata }
    )
  ...
  private async handleCreateMemoryRelation(args: any) {
    await this.intelligence.createMemoryRelation(
      args.fromId,
      args.toId,
      args.relationType,
      args.strength || 1.0
  ...
  private async handleGetCostMetrics(args: any) {
  ...
  private async handleOptimizeLocalUsage(args: any) {
  ...
  private async handleExecuteCommonCommand(args: any) {
  ...
  private async handleListAvailableCommands(args: any) {
...
`
  ...
  private async handleDocsTool(toolName: string, args: any) {
    const context = {
      docsIntelligence: this.docsIntelligence,
      projectDir: this.projectPath
    }

    const tool = docsTools[toolName as keyof typeof docsTools]
    if (!tool) {
